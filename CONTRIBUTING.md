...
3. 產品 skill、references 或驗證樣本的實質變更，優先考慮回報 [`POUND0423/AI-drama-pound`](https://github.com/POUND0423/AI-drama-pound)。
4. 不要附上使用者劇本、故事前提全文或任何憑證。
5. 產品 skill 契約見 [`docs/SKILL-SPEC.md`](docs/SKILL-SPEC.md)。
...
- 說明是否來自 upstream、是否改動 `skill-src/`／`validation/`，以及實際跑過哪些指令。
