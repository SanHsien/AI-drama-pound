#!/usr/bin/env python3
"""Validate every skill-src/*/SKILL.md against the Agent Skills frontmatter contract.

This is a Windows-friendly gate. Errors fail CI; warnings are printed and ignored.
Product skills stay in the upstream language; this script does not translate them.
